...
![Skills](https://skillicons.dev/icons?i=java,py,js,rust,spring,hibernate,react,nextjs,vue,tailwind,docker,kubernetes,redis,kafka,postgres,nodejs,androidstudio,numpy,ps,ae,pr&perline=8)
